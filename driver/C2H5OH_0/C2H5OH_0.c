...
static int adc_open(struct inode *inode,struct file *file)
{
	...
	adc_regs->adccon|=1<<14|adc_dev.pres<<6|adc_dev.ch<<3|0<<2;	//使用预分频，分频系数=(PCLK/ADCCLK-1),通道0,正常工作模式
...
static int __init adc_init(void)
{
	...
	if(err<0)
		...
		printk("The register of ethanol device is OK!\n");
	return 0;
}
