...
#ifdef CONFIGURE_DTB					//支持设备树
#define CONFIG_BOOTCOMMAND	"nand read.jffs2 0x30007FC0 kernel; nand read.jffs2 0x32000000 device_tree;bootm 0x30007FC0 - 0x32000000"
#else
...
#define	CFG_PROMPT		"My Uboot> "	/* Monitor Command Prompt	*/
